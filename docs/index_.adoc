...
image:https://kazurayam.github.io/BrowserMobProxyInKatalonStudio/diagrams/out/sequence/sequence.png[sequence]

Additionally, this project would show you a number of sample codes that post-processes the HAR file.

You can download the zip of the project from the link:https://github.com/kazurayam/BrowserMobProxyInKatalonStudio/releases/[Releases] page. You want to download the latest zip; unzip it; open the project with your local Katalon Studio; run the "Test Suite/TS1_WebUI.openBrowser"; when it finished you will find `sample.har` file is created in the project folder.
...
image:https://kazurayam.github.io/BrowserMobProxyInKatalonStudio/images/TS1_demoaut.katalon.com.png[TS1]
