...
When finished, you will find a new folder `work` has been created with 2 files:
...
Don't open the `*-source.har` file using text editor in Katalon Studio! If you double-click it, our poor Katalon Studio will hang. You will see a loading icon image:https://kazurayam.github.io/BrowserMobProxyInKatalonStudio/images/loading-42-1.gif[loading] rotating forever. You will have to kill Katalon Studio and restart it.
...
The `TS1_demoaut.katalon.com-source.jar` file will be a very large JSON text file. Using a text editor, you can't understand the content of HAR. You would need a tailored viewer for HAR file. I would recommend you to use link:https://code.visualstudio.com/[Visual Studio Code] with link:https://marketplace.visualstudio.com/items?itemName=unclebeast.har-viewer[HAR Viewer] plugin installed. The following image shows an example:

image:https://kazurayam.github.io/BrowserMobProxyInKatalonStudio/images/VSCode_HARViewer.png[VSCode with HAR Viewer]
