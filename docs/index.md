...
The `pretty.har` contains raw HTTP payloads of HTTP Request and Response captured by BrowserMob Proxy during the Test Suite execution. It is large. It has the size of 13 Megabytes.
...
The raw HAR file is very large. Usually it contains thousands of lines. If you open the `work/main_TS1_demoaut.katalon.com/pretty.har` file using a text editor in Katalon Studio, you would certainly feel depressed to look into it. A text editor is too poor to view a HAR.
