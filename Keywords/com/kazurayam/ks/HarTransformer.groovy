...
public class HarTransformer {

	public static void applyTemplates(Path inputHar, Closure transformer, Path outputJson) {

		List<Map<String, Object>> result = transformer.call(inputHar)
